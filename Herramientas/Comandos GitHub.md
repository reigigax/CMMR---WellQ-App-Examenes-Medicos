...
>> - **`git merge parche_01`** *(una vez en la rama principal "main" aplicamos este comando el cual traera los cambios trabajados en la rama "parche_01" y los aplicara a la rama principal "main" en la cual nos encontramos)*
